...
export async function ConvertEcg(
  inputText: string,
  adcBits: number,
  adcRange: number,
): Promise<any> {
  const response = await fetch(`${API_URL}/convert/ecg`, {
    method: "POST",
    headers: {
...
export const mcpDockerApi = {
  ...
  async toggleServer(
    ...
    const response = await fetch(
      `${API_URL}/mcp/docker/servers/${name}/toggle`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async startServer(
    ...
    const response = await fetch(
      `${API_URL}/mcp/docker/servers/${name}/start`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async callTool(
    ...
    const response = await fetch(
      `${API_URL}/mcp/docker/servers/${serverName}/call`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
